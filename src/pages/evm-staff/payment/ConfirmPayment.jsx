...
const DocumentIcon = ({ type }) => {
  if (type === "pdf") {
    return <FilePdf size={48} className="text-red-500" />;
  }
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <div className="flex items-center text-sm text-gray-500 mb-1">
              ...
              <CaretRight size={12} className="mx-1.5" />
        ...
        <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
          {/* Back Button */}
          <button className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-800 transition-colors">
